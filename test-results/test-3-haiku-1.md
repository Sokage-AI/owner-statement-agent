...
STEP 2 - CROSS-CHECK
 ...
 2f. COMPARE. Derived 302.60 against stated 347.60. Difference 45.00, outside tolerance.
 2g. CROSS-CHECK FAILED - derived 302.60 against stated 347.60, difference 45.00.

 Most likely involved: any of the four major line categories (income total, expense total, distribution, or the stated ending balance itself). The management fee line references a base rent of 4,375.00, which excludes the late fee as configured.

 This month does not tie out. A human needs to look at this before anything is sent to the owner.

STOPPED - no draft produced. Balance mismatch, 45.00. Human action required.
