# Owner profile: sample and template

**This file is already filled for the fictional Marcus Webb samples. Add it to your Claude Project
files or ChatGPT Project sources as-is for the quick test. Before a live run, make one copy per owner
and replace every sample detail.**

For this released version, keep one owner profile and the matching history file in the Project while
running that owner. Replace both before switching owners. This profile does not replace the seven
firm settings in `PROMPT.md`.
