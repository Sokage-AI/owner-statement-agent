...
**New in v3.** `FAILURES.md` row 6 was `PREDICTED` because **every statement in the earlier suite said
...
| Run | Result |
|---|---|
| Earlier suite | **No such test existed.** Row 6 fired in Test 6, but on a different condition |
| **Your v3 run** | |
