...
942.60. The earlier fixture landed on exactly 300.00, dead on the boundary.

## Result

| Run | Result |
|---|---|
| Original v1, Opus, 3 runs | ✅ **3/3** flagged it. None explained it away |
| Original v2 | **Not re-run** |
| **Your v3 run** | |
