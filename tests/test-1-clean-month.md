...
**Re-cut for v3.** The original fixture ended at 302.60 against the same $300 reserve floor — **$2.60 of
...
| Run | Result |
|---|---|
| Original v1, Opus, 3 runs *(302.60 fixture)* | ⚠️ **0/3.** Every run raised 2 flags where zero were correct |
| Original v2, Opus, 3 runs *(302.60 fixture)* | ✅ **3/3.** Zero flags |
