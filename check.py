...
and that single calculation is the whole safety case. This script checks that
arithmetic without asking a language model to grade its own result.

No dependencies. No network. No API key. Nothing leaves your machine.
Keep this file on your computer. Do not add it to Claude Project files.
